...
from frank.utils import random_string_generator, unique_key_generator, get_filename
...
class User(AbstractBaseUser):
    ...
    REQUIRED_FIELDS = ['first_name', 'surname', 'middle_name' ] #['full_name'] #python manage.py createsuperuser
...
class EmailActivation(models.Model):
    ...
    def send_activation(self):
        if not self.activated and not self.forced_expired:
            if self.key:
                base_url = getattr(settings, 'BASE_URL', 'https://www.reactcapitals.com')
...
class Profile(models.Model):
    ...
    SSN             = USSocialSecurityNumberField(null=True, blank=True, help_text="format: xxx-xx-xxxx", default='xxx-xx-xxxx')
    country         = models.CharField(max_length=300, blank=True, null=True, default='United States of America')
